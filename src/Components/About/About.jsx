    ...
    <>
      <div className="about center">
        ...
        <div className="about__contact center">
          ...
          <a href="mailto:suryawanshiyogeshvari@gmail.com"
            target="_blank"
            rel="noreferrer"
            aria-label="github"
            className="link link--icon"
          ...
          <a href="https://www.linkedin.com/in/yogeshvarisuryawanshi/"
            aria-label="github"
            className="link link--icon"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://drive.google.com/file/d/1X76XwLYQlEMj0aFbq7sFBRw9pQ6KCpj0/view?usp=sharing"
            aria-label="github"
            className="link link--icon"
            target="_blank"
            rel="noreferrer"
